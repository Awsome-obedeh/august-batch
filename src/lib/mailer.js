      ...
      <div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 40px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); overflow: hidden;">
          ...
          <div style="padding: 30px; text-align: center;">
            ...
            <p style="font-size: 16px; color: #333;">Thank you for reaching us up! .</p>
            
            <div style="margin: 30px 0;">
              <span style="font-size: 36px; font-weight: bold; letter-spacing: 5px; color: #007bff;">${message}</span>
            </div>

            <p style="font-size: 14px; color: #666;">You'll get response in <strong>10 minutes</strong>. If you did not request this, please ignore this email.</p>
